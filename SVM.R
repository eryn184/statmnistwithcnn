#Support Vector Machines (attempted)
############################################## Loading libraries ###########################################
...
str(mnist_test) # all dependant variables are characters, 60000 observations, 785 variables
str(mnist_train) # all dependant variables characters, 10000 observations, 785 variables
...
mnist_test <- mnist_test %>% mutate_if(is.character, as.numeric)
...
# Observations:
# Overall accuracy of 91.17%
# Specificities quite high > 98-99%
# Sensitivities good > 83%
...
# Observations:
# Overall accuracy of 92.45%, slightly imporved
...
# Observations
# Good accuracy of 95.11%
# High Sensitivities > 93% and specificities > 99%
...
## SVM using RBF kernel (C = 5, sigma = 0.01) achieved highest accuracy in predicting digits
